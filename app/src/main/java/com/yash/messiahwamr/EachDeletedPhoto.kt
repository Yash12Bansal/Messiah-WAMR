...
import com.yash.messiahwamr.databinding.ActivityEachDeletedPhotoBinding
import java.io.File
 ...
 */
class EachDeletedPhoto : AppCompatActivity() {
    lateinit var download: ImageView
    lateinit var share: ImageView
    lateinit var nparticularimage: ImageView

    private lateinit var binding: ActivityEachDeletedPhotoBinding
...
//        supportActionBar?.show()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityEachDeletedPhotoBinding.inflate(layoutInflater)
...
//        download=findViewById(R.id.download)
        ...
        println("URRIIEIEIE11 "+uri)

        var uri1= Uri.parse(uri)
        var destpath2= File(destpath)
        var file1= File(file)
//        var uu=FileProvider.getUriForFile(this,"com.statussaverwhatsapp.whatsappstatus",file1)

        Glide.with(applicationContext).load(uri).into(nparticularimage)
        val builder = StrictMode.VmPolicy.Builder()
        StrictMode.setVmPolicy(builder.build())

        println("1-00000000000000000000ER000000030------------------------------------------------34934934934934934934934934994943")
        println(uri1)
